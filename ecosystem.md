...
- 【Kotlin】[RTAkland/ROneBot](https://github.com/RTAkland/ROneBot)
...
- [avilliai/Eridanus](https://github.com/avilliai/Eridanus): 以llm函数调用(Function Calling)为核心编写的多功能机器人，插件化设计，具有一定拓展性。
